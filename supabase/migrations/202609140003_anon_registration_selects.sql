...
DROP POLICY IF EXISTS "branches_select_anon_registration" ON branches FOR SELECT
  TO anon USING (is_active = true);

DROP POLICY IF EXISTS "roles_select_anon_registration" ON roles FOR SELECT
  TO anon USING (true);